...
//   return (
//     <>
//       <header className="sticky top-0 z-50 bg-[#c8102e] text-white px-4 py-2 flex items-center justify-between md:px-16 sm:px-28 lg:px-44 3xl:px-60">
...
//               src={headerImage}
//               alt=""
//               className="w-28 xsm3:w-32 xxs:w-40 -mt-2 ml-2 xsm3:ml-2 xxs:ml-2"
//             />
//           </div>
//         </div>
...
//         {!userId ? (
//           <>
//             <div className="flex gap-2 xsm4:gap-2 xsm3:gap-2  xxs:gap-2">
//               <button
//                 className="border border-white px-4 xsm4:px-5 py-1 xsm3:px-5 xxs:px-5 rounded-[8px] bg-[linear-gradient(99.61deg,#C10932_0.52%,#5B0418_99.48%)] text-ssm font-medium
// "
...
//               </button>
//               <button
//                 className="bg-white text-red px-4 xsm4:px-5 xsm3:px-5 xxs:px-5 py-1 rounded-[8px] text-ssm font-medium"
      ...
      {!userId ? (
        ...
        <>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="bg-white text-red text-xs font-medium px-3 py-1.5 rounded-full md:hidden whitespace-nowrap"
              onClick={() => navigate("/deposit")}
            >
              Deposit
            </button>
            ...
            {/* User Balance */}
            <div
              className="flex items-center bg-[linear-gradient(104.41deg,#4EB92B_4.93%,#235313_95.07%)] text-white px-3 py-1 rounded-full gap-2 cursor-pointer"
              onClick={toggleSidebar}
            >
