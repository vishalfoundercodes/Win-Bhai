              ...
              Casino Vivo
                ...
                <div className="flex justify-between mb-3 gap-2">
                  ...
                  <div className="relative w-full">
                    ...
                    <button
                      className="w-full flex items-center justify-between rounded-xl px-3 py-2 bg-white lg2:bg-lgGray lg2:text-black shadow-sm text-ssm font-medium cursor-pointer"
                      onClick={() =>
                        setDropdownModal(
                  ...
                  <div className="relative w-full">
                    ...
                    {dropdownModal === "range" && (
                      <div className="absolute mt-1 w-full bg-white lg2:bg-lgGray lg2:text-black  rounded-xl shadow-lg z-10 text-[12px] font-medium">
                        {[
                          "Today",
                          "Yesterday",
                          "Last 7 Days",
