    ...
    >
      <div className="w-full ">
        ...
        <div className="bg-red lg2:rounded-t-2xl p-2 px-4 hidden lg:block">
          <h2 className="text-white text-sm font-bold">Deposit History</h2>
        </div>
            ...
            <div className="mb-3">
              ...
              <div className="flex justify-between gap-2 mb-2">
                <button
                  ...
                  className="w-full bg-lightGray lg2:bg-lgGray lg2:text-black text-white py-2 rounded-[8px] font-medium text-ssm"
                >
                  Just For Today
                </button>
                <button
          ...
          : "bg-white text-lightGray border-grayBorder"
            ...
            <div className="space-y-3">
              {filteredData.map((deposit, index) => (
                <div
                  key={index}
                  className="bg-white lg2:bg-lgGray rounded-xl shadow p-4 flex justify-between items-center"
                >
                  <div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-black2 font-bold">
                      <span className="text-red-600">₹</span> {deposit.cash}
                    </p>
                  </div>
                </div>
              ))}
