...
export default function Sidebar({
 ...
 rounded-[8px] p-1 w-20 h-18"
          ...
          <ul className="divide-y divide-grayBorder font-medium px-4">
            ...
            <li
              className="flex items-center gap-3 py-3 px-2 cursor-pointer justify-between"
              onClick={() => {
                onClose();
            ...
            >
              ...
              <div className="w-6 h-6 flex items-center justify-center rounded-full bg-red text-white text-xs">
                {apiNotifications || 0}
              </div>
            </li>
          </ul>
