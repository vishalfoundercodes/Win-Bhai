    ...
    <>
      <div className="lg2:px-4">
        <div className="lg2:flex lg2:gap-4 mb-4 lg2:mt-0 hidden">
          ...
          >
            ...
            <div className="lg2:flex lg2:flex-col ">
              ...
              <p className="text-ssm text-gray-600 text-center lg2:text-start">
        ...
        <div className="bg-red lg2:rounded-t-2xl p-2 px-4 hidden lg:block">
          <h2 className="text-white text-sm font-semibold">Reedem</h2>
        </div>
        <div className=" mt-4 lg2:mt-0 bg-white rounded-xl lg2:rounded-t-none shadow p-4 gap-3 lg2:items-center lg2:justify-start lg2:flex hidden">
          <div className="flex w-full lg2:w-auto items-center gap-2">
            ...
            />
            <button
              className="bg-red hover:bg-[#a60d25] text-white px-4 py-2 lg2:px-8 rounded-md text-ssm font-semibold cursor-pointer"
        ...
        <div className="min-h-screen bg-gray-100 lg2:bg-transparent flex flex-col items-center p-4 lg2:p-0 pt-0">
          {/* Coupon Section */}
          ...
          {/* Bonus Status */}
          <div className="w-full max-w-m bg-white rounded-xl shadow mt-4 p-10 flex flex-col items-center">
            ...
            <p className="text-black text-sm font-semibold">
              No pending bonus to claim
            </p>
            <p className="text-ssm text-darkGray text-center mt-1">
              Enter your valid coupon code to redeem your bonus rewards
            </p>
          </div>

          {/* Trusted Gaming Section */}
          <div className="w-full max-w-m bg-white rounded-xl shadow mt-4 px-10 py-4 flex flex-col items-center">
            <img src={trustedGame} alt="Trophy" className="w-28 h-24 mb-2" />
            <h3 className="text-black text-sm font-semibold">
              Trusted Gaming Platform
            </h3>
            <p className="text-ssm text-darkGray text-center mt-1">
              Certified secure platform with instant payouts and fair gaming
            </p>
            ...
            <div className="mt-3 space-y-3 text-sm">
              <div className="flex justify-between items-center">
                <div className="flex gap-2">
                  ...
                  <div className="flex flex-col">
                    <p className="text-black font-medium">Deposit</p>
              ...
              <div className="flex justify-between items-center">
                <div className="flex gap-2">
                  ...
                  <div className="flex flex-col">
                    <p className="text-black font-medium">Welcome Bonus</p>
                    <p className="text-xs text-gray-500">Yesturday, 9:30 PM</p>
                  </div>
                </div>
                <p className="text-[#6C8FCB] font-semibold">+ ₹100</p>
              </div>
