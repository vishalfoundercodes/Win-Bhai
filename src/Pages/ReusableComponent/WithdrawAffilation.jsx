          ...
          <div className="flex items-center gap-2">
            ...
            <div className=" w-full ">
              ...
              <div className="space-y-4 p-4">
                {/* Total Commission */}
                <div className="bg-white rounded-lg shadow p-4 border-l-5 border-red-300">
                ...
                <div className="bg-white rounded-lg shadow p-4 border-l-5 border-red">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center">
                ...
                <div className="flex w-full items-center justify-center">
                  <button
                    className="px-8 py-3 bg-red text-white rounded-[8px] flex gap-2 items-center justify-center text-ssm"
