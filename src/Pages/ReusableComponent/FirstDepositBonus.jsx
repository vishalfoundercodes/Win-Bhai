            ...
            <div key={i} className="bg-white shadow rounded-md p-3">
              ...
              <div className="flex justify-between items-center mb-1">
                <span className="text-sm font-semibold">
                  First Deposit <span className="text-red">₹100</span>
                </span>
                <span className="text-green-600 font-semibold">+ ₹106</span>
              </div>

              {/* Description */}
              <p className="text-xs text-gray-500 mb-2">
                Deposit ₹100 for the first time in your account and receive
                ₹106.
              </p>
