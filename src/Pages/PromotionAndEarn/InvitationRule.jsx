      ...
      <div className=" min-h-screen flex flex-col items-center pb-6">
        <div className="w-full text-black rounded-lg ">
          ...
          <div className="p-4 text-center text-lg">
            ...
            <p className="text-black opacity-65 text-[15px]">
            ...
            {rules.map((rule) => (
              ...
              >
                ...
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="bg-[#b70e2d] text-white font-bold px-8 py-1 rounded-[10px] text-sm shadow-md">
                    {rule.id}
                  </span>
                </div>
          ...
          <div className="p-4 space-y-4">
            {rules2.map((rule, index) => (
              <div
                key={index}
                className="bg-white  rounded-lg p-4 text-sm text-black"
              >
