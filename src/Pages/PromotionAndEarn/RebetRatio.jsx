      ...
      <div className="p-2 px-4 lg2:pr-4 lg2:p-0 ">
        <div className="w-full ">
          ...
          <div className="bg-red lg2:rounded-t-2xl p-2 px-4 hidden lg:block">
            <h2 className="text-white text-sm font-semibold">Rebate Ratio</h2>
          </div>
          <div className="lg2:bg-white">
              ...
              <div className="w-full ">
                ...
                <div className="p-4 space-y-4 ">
                  {rebateData.map((rebate, index) => (
                    <div
                      key={index}
                      className="bg-white lg2:bg-lgGray  rounded-lg p-4"
                    >
                      <h2 className="text-[15px] lg2:text-[20px] flex items-center gap-2 text-black lg2:text-black2 lg2:font-semibold mb-3">
                        Rebate level{" "}
