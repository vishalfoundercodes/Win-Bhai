...
//     { id: "sports", label: "Casino", type: "custom", icon: Cassino, brand_id:"78" },
//     { id: "maincassino", label: "Casino", type: "custom", icon: Cassino ,brand_id:"78"},
...
export default function Game() {
  ...
  const tabConfig = {
    ...
    slot: { label: "Slot", brand_id: "49" },
    aviator: { label: "Aviator", brand_id: "52" },
  ...
  return (
    <div className="">
      ...
      <div className="lg2:w-full lg2:grid lg2:grid-cols-12 lg2:gap-16 h-screen">
        <div className="lg2:col-span-12">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-1 px-4 lg2:px-0 lg2:pr-4 py-2 pt-4">
              {IconComp && (
          ...
          {/* Provider name */}
          <div className="py-2 text-gray-700 text-lg font-semibold px-4 lg2:px-0 lg2:pr-4 ">
            <h2 className=" lg2:px-0 lg2:pr-4 ">Choose Provider</h2>
